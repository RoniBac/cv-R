    ...
    <div>
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    ...
                    <li class="github"><a href={github} target="_blank">{github}</a></li>
                </ul>
            ...
            <div class="languages-container container-block">
                ...
                <ul class="list-unstyled interests-list spanish hidden">
                    <li>{idioma1} <span class="lang-desc">(Nativo)</span></li>
                    <li>{idioma2} <span class="lang-desc">(Profesional)</span></li>
                </ul>
            </div>
